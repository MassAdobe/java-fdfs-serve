...
public class RedisClient {
     ...
     * @return
     */
    public void expire(String key, long time) throws AttemptException {
        try {
            if (time > 0) {
            ...
            throw new AttemptException(ErrorCodeMsg.REDIS_ERROR);
        }
    }
     ...
     */
    public long getExpire(String key) throws AttemptException {
        try {
     ...
     */
    public boolean hasKey(String key) throws AttemptException {
        try {
     ...
     * @param value 值
     */
    public void set(String key, Object value) throws AttemptException {
        try {
     ...
     */
    public void set(String key, Object value, long time) throws AttemptException {
        try {
            String val = objectMapper.writeValueAsString(value);
     ...
     * @return
     */
    public long incr(String key, long delta) throws AttemptException {
        if (delta < 0) {
            logger.error(Strings.lenientFormat("【REDIS-CLIENT-INCR】：%s", ErrorCodeMsg.REDIS_INCR_ERROR.getMessage()));
            throw new AttemptException(ErrorCodeMsg.REDIS_INCR_ERROR);
        }
     ...
     * @return
     */
    public long decr(String key, long delta) throws AttemptException {
        if (delta < 0) {
     ...
     */
    public void hmset(String key, Map<String, Object> map) throws AttemptException {
        try {
     ...
     * @param time 时间(秒)
     */
    public void hmset(String key, Map<String, Object> map, long time) throws AttemptException {
        try {
     ...
     * @param value 值
     */
    public void hset(String key, String item, Object value) throws AttemptException {
        try {
            String val = objectMapper.writeValueAsString(value);
     ...
     */
    public void hset(String key, String item, Object value, long time) throws AttemptException {
        try {
            String val = objectMapper.writeValueAsString(value);
     ...
     * @return
     */
    public Set<Object> sGet(String key) throws AttemptException {
        try {
     ...
     * @param value 值
     */
    public boolean sHasKey(String key, Object value) throws AttemptException {
        try {
            String val = objectMapper.writeValueAsString(value);
     ...
     */
    public void sSet(String key, Object... values) throws AttemptException {
        try {
     ...
     * @param values 值 可以是多个
     */
    public void sSetAndTime(String key, long time, Object... values) throws AttemptException {
        try {
     ...
     * @return
     */
    public long sGetSetSize(String key) throws AttemptException {
        try {
     ...
     * @param values 值 可以是多个
     */
    public void setRemove(String key, Object... values) throws AttemptException {
        try {
     ...
     * @return
     */
    public List<Object> lGet(String key, long start, long end) throws AttemptException {
        try {
     ...
     * @return
     */
    public long lGetListSize(String key) throws AttemptException {
        try {
     ...
     * @return
     */
    public Object lGetIndex(String key, long index) throws AttemptException {
        try {
     ...
     * @return
     */
    public void lSet(String key, Object value) throws AttemptException {
        try {
            String val = objectMapper.writeValueAsString(value);
     ...
     * @return
     */
    public void lSet(String key, Object value, long time) throws AttemptException {
        try {
            String val = objectMapper.writeValueAsString(value);
     ...
     * @return
     */
    public void lSet(String key, List<Object> value) throws AttemptException {
        try {
     ...
     * @param time  时间(秒)
     */
    public void lSet(String key, List<Object> value, long time) throws AttemptException {
        try {
     ...
     * @param value 值
     */
    public void lUpdateIndex(String key, long index, Object value) throws AttemptException {
        try {
            String val = objectMapper.writeValueAsString(value);
     ...
     * @param value 值
     */
    public void lRemove(String key, long count, Object value) throws AttemptException {
        try {
            String val = objectMapper.writeValueAsString(value);
